...
## 🖥️ Steam & PC Projeleri
PC platformu için geliştirilen, Unity'nin modern ağ mimarisiyle inşa edilmiş projelerdir.

### ⚔️ Multiplayer Project I & II
- **Networking:** Unity **Netcode for GameObjects** (NGO) kullanılarak geliştirildi.
- **Teknik:** Server-Authoritative mimari, Client-side prediction ve veri senkronizasyonu süreçleri yönetildi.
- **Platform:** Steam (PC).

---

## 🧩 Mobil Puzzle Serisi (Published)
2D mantık ve zeka oyunlarını kapsayan, market süreçleri tamamlanmış projelerdir. (App store ve Play store)

### 🔳 Grid-X (Nodex)
Stratejik çizgi birleştirme oyunu. Neon tarzda UI tasarımı ve optimize edilmiş grid sistemleri mevcuttur.

### 📝 Words Hunter (Multiplayer)
Mirror mimarisi ve **Firebase Realtime Database** kullanılarak geliştirilmiş, kelime bulmaca tabanlı çok oyunculu deneyim.

### 🌌 GalaxySudoku, Numberlink & ColorSort
Farklı puzzle mekaniklerine sahip, yüksek performanslı 2D zeka oyunları serisi.
...
- **Engine:** Unity 6 (Gelişmiş 2D & 3D Projeler).
